...
<head>
    ...
    <title>Mercedes Service Request</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --mercedes-blue: #00a9e0;
            --mercedes-dark: #1d1d1b;
            --mercedes-silver: #d1d1d1;
            --mercedes-light: #f5f5f5;
        }
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(0,169,224,0.4) 100%);
            z-index: -1;
        }
        ...
        .price-display {
            background-color: var(--mercedes-light);
            padding: 15px;
            border-radius: 8px;
            margin-top: 20px;
            text-align: right;
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/mercedes.png" alt="Mercedes Logo" class="logo">
            <h1>Mercedes Service Request</h1>
            <p class="subtitle">Quality Service for Your Mercedes Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers MERCIDISE">4 Wheelers CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> Mercedes-Benz Service Center. All Rights Reserved.
        </div>
    </div>
