...
<head>
    ...
    <title>NISSAN Service Request</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --nissan-red: #c3002f;
            --nissan-dark: #1d1d1b;
            --nissan-silver: #d1d1d1;
            --nissan-light: #f5f5f5;
        }
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(195,0,47,0.4) 100%);
            z-index: -1;
        }
        ...
        input:focus, select:focus, textarea:focus {
            outline: none;
            border-color: #c3002f;
            box-shadow: 0 0 0 2px rgba(195, 0, 47, 0.2);
        }
        ...
        button:hover {
            ...
            box-shadow: 0 8px 20px rgba(195, 0, 47, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/nissan.png" alt="NISSAN Logo" class="logo">
            <h1>NISSAN Service Request</h1>
            <p class="subtitle">Quality Service for Your NISSAN Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers NISSAN">4 Wheelers CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> NISSAN Motors Service Center. All Rights Reserved.
        </div>
    </div>
