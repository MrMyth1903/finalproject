...
<video class="background-video" id="bgVideo" autoplay muted loop>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/nissan.png" alt="Audi Logo" class="logo">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers NIssan">Nissan (4 Wheelers)</option>
        ...
        <div class="footer">
            ...
            &copy; <?php echo date('Y'); ?> Nissan Service Center. All Rights Reserved.
        </div>
    </div>
