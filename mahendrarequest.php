...
<video class="background-video" id="bgVideo" autoplay muted loop>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/mahindra.png" alt="Audi Logo" class="logo">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers Mehendra">Mahendra (4 Wheelers)</option>
        ...
        <div class="footer">
            ...
            &copy; <?php echo date('Y'); ?> Mahendra Service Center. All Rights Reserved.
        </div>
    </div>
