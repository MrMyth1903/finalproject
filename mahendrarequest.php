...
<head>
    ...
    <title>Mahindra Service Request</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --mahindra-red: #e62020;
            --mahindra-dark: #1d1d1b;
            --mahindra-silver: #d1d1d1;
            --mahindra-light: #f5f5f5;
        }
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(226,65,15,0.4) 100%);
            z-index: -1;
        }
        ...
        .price-display {
            background-color: var(--mahindra-light);
            padding: 15px;
            border-radius: 8px;
            margin-top: 20px;
            text-align: right;
        ...
        button:hover {
            ...
            box-shadow: 0 8px 20px rgba(230, 32, 32, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/mahindra.png" alt="Mahindra Logo" class="logo">
            <h1>Mahindra Service Request</h1>
            <p class="subtitle">Quality Service for Your Mahindra Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers MAHENDRA">4 Wheelers CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> Mahindra Service Center. All Rights Reserved.
        </div>
    </div>
