...
<video class="background-video" id="bgVideo" autoplay muted loop>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/honda.png" alt="Audi Logo" class="logo">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers Honda">Honda (4 Wheelers)</option>
                                <option value="2 Wheelers Honda">Honda (2 Wheelers)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-col">
