...
<head>
    ...
    <title>MG Service Request</title>
    ...
    <style>
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(226,46,0,0.4) 100%);
            z-index: -1;
        }
        ...
        .form-section h2 {
            ...
            color: var(--mg-dark);
            padding-bottom: 10px;
            border-bottom: 2px solid #e22e00;
        ...
        input:focus, select:focus, textarea:focus {
            outline: none;
            border-color: #e22e00;
            box-shadow: 0 0 0 2px rgba(226, 46, 0, 0.2);
        }
        ...
        button {
            ...
            letter-spacing: 1px;
            transition: all 0.3s ease;
            box-shadow: 0 5px 15px rgba(226, 46, 0, 0.3);
        }
        
        button:hover {
            background-color: #c12700;
            transform: translateY(-2px);
            box-shadow: 0 8px 20px rgba(226, 46, 0, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/MG.png" alt="MG Logo" class="logo">
            <h1>MG Service Request</h1>
            <p class="subtitle">Quality Service for Your MG Hector</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers MG-HECTOR">4 Wheelers CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> MG Motors Service Center. All Rights Reserved.
        </div>
    </div>
