...
<head>
    ...
    <title>TATA Service Request</title>
    ...
    <style>
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(226,75,47,0.4) 100%);
            z-index: -1;
        }
        ...
        .form-section h2 {
            ...
            color: var(--tata-dark);
            padding-bottom: 10px;
            border-bottom: 2px solid #E24B2F;
        ...
        input:focus, select:focus, textarea:focus {
            outline: none;
            border-color: #E24B2F;
            box-shadow: 0 0 0 2px rgba(226, 75, 47, 0.2);
        }
        ...
        .price-display {
            background-color: var(--tata-light);
            padding: 15px;
            border-radius: 8px;
            margin-top: 20px;
            text-align: right;
        ...
        button {
            ...
            letter-spacing: 1px;
            transition: all 0.3s ease;
            box-shadow: 0 5px 15px rgba(226, 75, 47, 0.3);
        }
        
        button:hover {
            background-color: #c13f27;
            transform: translateY(-2px);
            box-shadow: 0 8px 20px rgba(226, 75, 47, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/tata.png" alt="TATA Logo" class="logo">
            <h1>TATA Service Request</h1>
            <p class="subtitle">Quality Service for Your TATA Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers TATA">4 Wheelers CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> TATA Motors Service Center. All Rights Reserved.
        </div>
    </div>
