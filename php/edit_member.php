...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $updateQuery = "UPDATE members SET firstname=?, middlename=?, lastname=?, phoneNumber=?, aadharNo=?, vehicle=? WHERE id=?";
...
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <input type="text" name="middlename" value="<?= htmlspecialchars($user['middlename']) ?>"  placeholder="Middle Name">
