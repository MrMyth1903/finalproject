...
if (isset($_POST['submit'])) {
    ...
    $checkQuery = "SELECT * FROM emergency_appointment WHERE SERVICE = ? AND DATE = ? AND TIME = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $stmt = $con->prepare("INSERT INTO emergency_appointment (SERVICE, DATE, TIME, NAME, VEHICLE_NO, WANT, SPHERE_PART, PHONE_NUMBER) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
