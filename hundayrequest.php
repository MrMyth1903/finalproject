...
<head>
    ...
    <title>Hyundai Service Request</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --hyundai-blue: #003282;
            --hyundai-dark: #1d1d1b;
            --hyundai-silver: #d1d1d1;
            --hyundai-light: #f5f5f5;
        }
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(0,50,130,0.4) 100%);
            z-index: -1;
        }
        ...
        input:focus, select:focus, textarea:focus {
            ...
            box-shadow: 0 0 0 2px rgba(0, 50, 130, 0.2);
        }
        ...
        .price-display {
            background-color: var(--hyundai-light);
            padding: 15px;
            border-radius: 8px;
            margin-top: 20px;
            text-align: right;
            font-size: 18px;
            font-weight: 600;
            border-left: 4px solid var(--hyundai-blue);
        }
        ...
        button {
            ...
            letter-spacing: 1px;
            transition: all 0.3s ease;
            box-shadow: 0 5px 15px rgba(0, 50, 130, 0.3);
        }
        
        button:hover {
            background-color: #002662;
            transform: translateY(-2px);
            box-shadow: 0 8px 20px rgba(0, 50, 130, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/hyundai.png" alt="Hyundai Logo" class="logo">
            <h1>Hyundai Service Request</h1>
            <p class="subtitle">Quality Service for Your Hyundai Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers HYUNDAI">4 Wheelers, CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> Hyundai Service Center. All Rights Reserved.
        </div>
    </div>
