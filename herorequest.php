...
<head>
    ...
    <title>Hero Service Request</title>
    ...
    <style>
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(230,60,47,0.4) 100%);
            z-index: -1;
        }
        ...
        .price-display {
            ...
            font-size: 18px;
            font-weight: 600;
            border-left: 4px solid var(--hero-red);
        }
        ...
        button {
            ...
            letter-spacing: 1px;
            transition: all 0.3s ease;
            box-shadow: 0 5px 15px rgba(230, 60, 47, 0.3);
        }
        
        button:hover {
            background-color: #d02e21;
            transform: translateY(-2px);
            box-shadow: 0 8px 20px rgba(230, 60, 47, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/hero.png" alt="Hero Logo" class="logo">
            <h1>Hero Service Request</h1>
            <p class="subtitle">Quality Service for Your Hero Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="2 Wheelers HERO">2 Wheelers BIKE</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> Hero MotoCorp Service Center. All Rights Reserved.
        </div>
    </div>
