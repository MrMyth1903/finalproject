...
<video class="background-video" id="bgVideo" autoplay muted loop>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/hero.png" alt="Audi Logo" class="logo">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="select1" name="type">
                                <option value="2 Wheelers Hero">Hero (2 Wheelers)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-col">
        ...
        <div class="footer">
            ...
            &copy; <?php echo date('Y'); ?> Hero Service Center. All Rights Reserved.
        </div>
    </div>
