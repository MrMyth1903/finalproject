...
<head>
    ...
    <title>BMW Service Request</title>
    ...
    <style>
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(0,102,177,0.4) 100%);
            z-index: -1;
        }
        ...
        button:hover {
            ...
            box-shadow: 0 8px 20px rgba(0, 102, 177, 0.4);
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/bmw.png" alt="BMW Logo" class="logo">
            <h1>BMW Service Request</h1>
            <p class="subtitle">Quality Service for Your BMW Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                ...
                                <option value="2 Wheelers BMW">2 Wheelers, BIKE</option>
                                <option value="4 Wheelers BMW">4 Wheelers, CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> BMW Service Center. All Rights Reserved.
        </div>
    </div>
