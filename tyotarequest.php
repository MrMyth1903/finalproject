...
<head>
    ...
    <title>Toyota Service Request</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --toyota-red: #e63c2f;
            --toyota-dark: #1d1d1b;
            --toyota-silver: #d1d1d1;
            --toyota-light: #f5f5f5;
        }
...
<body>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/toyota.png" alt="Toyota Logo" class="logo">
            <h1>Toyota Service Request</h1>
            <p class="subtitle">Quality Service for Your Toyota Vehicle</p>
        </header>
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <select id="select1" name="type">
                                <option value="4 Wheelers TYOTA">4 Wheelers CAR</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="footer">
            &copy; <?php echo date('Y'); ?> Toyota Motors Service Center. All Rights Reserved.
        </div>
    </div>
