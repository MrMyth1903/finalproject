...
<video class="background-video" id="bgVideo" autoplay muted loop>
    ...
    <div class="container">
        <header>
            <img src="servicelogo/toyota.png" alt="Audi Logo" class="logo">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="select1" name="type">
                                <option value="2 Wheelers Toyota">Toyota (4 Wheelers)</option>
        ...
        <div class="footer">
            ...
            &copy; <?php echo date('Y'); ?> TYOTA Service Center. All Rights Reserved.
        </div>
    </div>
